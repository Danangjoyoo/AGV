...
void loop() {
  straight();  delay(2800);
  //fewr();      delay(500);
  goRight();   delay(880);//==============//BELOK KANAN 1
  straight();  delay(1400);
  goRight();   delay(850);//==============//BELOK KANAN 2
  straight();  delay(280);
  goRight();   delay(750);//============= //BELOK KANAN 3
  straight();  delay(250);
  goLeft();    delay(930);//============== //BELOK KIRI 1
  straight();  delay(900);
  goLeft();    delay(980);//===============//BELOK KIRI 2
  straight();  delay(150);
  goRight();   delay(830);//==============//BELOK KANAN 4
  straight();  delay(1100);
  goRight();   delay(880);//=============//BELOK KANAN 5
  straight();  delay(1500);
  goRight();   delay(880);//=============//BELOK KANAN 6
  straight();  delay(1400);
  /*straight();  delay(1400);
  fewr();      delay(500);
  straight();  delay(1000);
  goRight();   delay(1150);//==============//BELOK KANAN 1
  straight();  delay(1100);
  fewr();      delay(600);
  goRight();   delay(1000);//==============//BELOK KANAN 2
  straight();  delay(300);
  goRight();   delay(1000);//============= //BELOK KANAN 3
  straight();  delay(350);
  goLeft();    delay(800);//============== //BELOK KIRI 1
  straight();  delay(1600);
  goLeft();    delay(800);//===============//BELOK KIRI 2
  straight();  delay(400);
  goRight();   delay(1200);//==============//BELOK KANAN 4
  straight();  delay(1300);
  fewr();      delay(700);
  goRight();   delay(1100);//=============//BELOK KANAN 5
  straight();  delay(1300);
  fewr();      delay(1000);
  goRight();   delay(1100);//=============//BELOK KANAN 6
  straight();  delay(1800);
  fewr();      delay(1400);*/
}
...
void goRight(){
  steerServo.write(135);
  analogWrite(velocL, fulp*0.95);
  analogWrite(velocR, fulp*0.95);
  digitalWrite(in1, LOW);
  digitalWrite(in2, HIGH);
  digitalWrite(in3, LOW);
  digitalWrite(in4, HIGH);
